Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage         = "https://github.com/Pinturaj/FolioReaderKit"
  ...
  s.source           = { :git => "https://github.com/Pinturaj/FolioReaderKit.git", :tag => s.version.to_s }
  ...
  s.dependency 'RealmSwift', '10.45.2'
